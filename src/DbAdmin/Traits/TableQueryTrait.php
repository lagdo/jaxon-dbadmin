...
trait TableQueryTrait
{
     ...
     * @return mixed
     */
    private function getRowFieldValue(TableFieldEntity $field, string $name, $row, string $update, array $queryOptions)
    {
     ...
     * @return string|null
     */
    private function getRowFieldFunction(TableFieldEntity $field, string $name, $value, string $update, array $queryOptions)
    {
